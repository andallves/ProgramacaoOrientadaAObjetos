...
using QuartaAtividade.Entities;
        ...
        try
        {
            ...
            switch (userResponse)
            {
                ...
                case 3:
                    ...
                    Cidadao cidadaoParaAgendamento = funcionario.PegarCidadao(cpfParaAgendamento);
                    Console.Write("Infome a data: ");
                    DateTime dataDeVacinacao = DateTime.ParseExact(Console.ReadLine(), "dd/MM/yyyy HH:mm",
                        CultureInfo.InvariantCulture);
                    funcionario.RealizarAgendamento(cidadaoParaAgendamento, dataDeVacinacao);
                    break;
                default:
